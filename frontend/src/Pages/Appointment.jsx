...
const {doctor, currencySymbol, token, getDoctorsData} = useContext(AppContext)
...
const bookAppointment = async () => {
  ...
  try {
    if (!docSlots[slotIndex] || !docSlots[slotIndex][0]) {
      toast.error('Please select a valid date slot');
      return;
    }
    ...
    const date = docSlots[slotIndex][0].datetime
    // const time = docSlots[slotIndex][0].time
  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        {/*---- Booking slots ----*/}
        <div className='sm:ml-72 sm:pl-4 font-medium textgray-700'>
          <p>Booking slots</p>
