...
//   email:'akshradavid@gmail.com',
//   phone:'+91 999-699-7832',
//   address:{
...

      {
        isEdit ? <label htmlFor="image">
          <div className="inline-block relative cursor-pointer">
                ...
                <img className="w-10 absolute bottom-12 right-12" src={image ? '': assets.upload_icon} alt="profile" />
          </div>
          ...
          <input onChange={(e) => setImage(e.target.files[0])} type="file" id="image" />
              ...
              // : <img className="w-36 rounded" src={image ? image : undefined} alt="profile" />
              // : <img className="w-36 rounded" src={image || assets.profile_pic} alt="profile" />
